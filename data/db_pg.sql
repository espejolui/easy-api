...
-- Insertar datos en la tabla 'day'
...
-- Leer datos de la tabla 'recipe'
SELECT id, title FROM recipe;

-- Leer datos de la tabla 'recipe' con joins
...
-- Crear la tabla 'recipe_ingredient'
